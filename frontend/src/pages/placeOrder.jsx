 ...
 const [method,setMethod] = useState('cod');
  return (
    <section className="w-full min-h-screen px-6 md:px-16 py-16 grid grid-cols-1 md:grid-cols-2 gap-12">
      {/* LEFT - Delivery Info */}
      <div>
        <h2 className="text-2xl font-semibold tracking-wide mb-8">DELIVERY <span className="text-gray-700">INFORMATION</span></h2>
        ...
        <input className="border rounded-lg p-3 w-full mt-4"
